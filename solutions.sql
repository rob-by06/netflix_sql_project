...
SELECT type, title, SPLIT_PART (duration, ' ', 1) :: INT 
FROM netflix
...
10.Find each year and number of movies and series release in India on netflix. 
return top 5 years with highest content release!
